...
export const env = {
  ...
  BETTER_AUTH_URL: normalizeOrigin(getEnv("BETTER_AUTH_URL")),
  BETTER_AUTH_TRUSTED_ORIGIN: normalizeOrigin(
    getEnvOptional("BETTER_AUTH_TRUSTED_ORIGIN", getEnv("BETTER_AUTH_URL"))
  ),
