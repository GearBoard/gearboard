  ...
  return (
    <div className="bg-white rounded-xl border-[1.5px] border-gray shadow-primary-red px-6 py-6 md:px-8 md:py-8 flex flex-col gap-4 md:gap-5 w-full">
      ...
      <button
        ...
        className="h-9.5 md:h-12 w-full flex items-center justify-center gap-3 border-[1.5px] bg-white border-gray rounded-[10px] px-3.75 py-2 md:py-3 text-base font-medium hover:bg-light-gray transition-colors cursor-pointer text-black/54 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        <GoogleIcon />
